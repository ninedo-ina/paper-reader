...
当前已发布基线为 `feature/v0.1.30`，生产已核验为 `0.1.30`；当前待发布迭代为 `feature/v0.1.31`。后续版本统一遵循上述流程。历史版本分支全部保留，不以早期初始化基线替代当前 `dev`。
...
## 21. v0.1.31 PaperHelper 菜单文案调整（待发布）
...
- 当前状态：代码和文档已完成，测试、提交、合并、部署与线上验收待完成。
