...
- 当前发布版本：`0.1.49`（语言面板隐藏滚动条但保留滚动，`REQ-202609-0111` 收尾，2026-09-16 UTC 已发布）
- 当前发布版本分支：`feature/v0.1.49`；生产当前运行 `0.1.49`（2026-09-16 UTC 已核验）
- 开发中版本：无（`0.1.49` 已发布，下一迭代尚未开始）
