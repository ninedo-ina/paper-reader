...
- 当前发布版本：`0.1.48`（国际化语言切换与登录页语言下拉修复，`REQ-202609-0111`，2026-09-16 UTC 已发布）
- 当前发布版本分支：`feature/v0.1.48`；生产当前运行 `0.1.48`（2026-09-16 UTC 已核验）
- 开发中版本：无（`0.1.48` 已发布，下一迭代尚未开始）
- 长期分支：`dev`（集成）、`main`（默认/生产）
- 生产域名：`https://paper.pilo.eu.cc`
- 文档核对日期：2026-09-16（UTC）
