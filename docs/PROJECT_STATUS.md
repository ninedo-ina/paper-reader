...
> 当前发布版本：`0.1.44`；发布分支：`feature/v0.1.44`（提交 `6327bfe`）；当前生产版本：`0.1.44`（2026-09-15 UTC 已核验，`/api/health` 返回 `0.1.44`，登录验证码邮件已在线收到）；核对日期：2026-09-15（UTC）；生产域名：`https://paper.pilo.eu.cc`
