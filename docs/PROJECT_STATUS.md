...
> 当前发布版本：`0.1.45`；发布分支：`feature/v0.1.45`；当前生产版本：`0.1.45`（2026-09-15 UTC 已核验，`/api/health` 返回 `0.1.45`；上一版 `0.1.44` 的登录验证码邮件已在线收到）；核对日期：2026-09-15（UTC）；生产域名：`https://paper.pilo.eu.cc`
