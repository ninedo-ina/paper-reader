...
> 当前迭代版本：`0.1.31`；迭代分支：`feature/v0.1.31`；上一已发布/当前生产版本：`0.1.30`（2026-08-30 UTC 已核验）；核对日期：2026-08-31（UTC）；生产域名：`https://paper.pilo.eu.cc`
...
- 集成分支：`dev`。
- 当前迭代分支：`feature/v0.1.31`，基于最新 `main` 的 `af734eb` 创建；本轮需求是将侧栏“我的创作”改为“我的论文”。
- 上一发布分支：`feature/v0.1.30`，已按发布流程合并到 `main`；生产当前仍运行 `0.1.30`。
