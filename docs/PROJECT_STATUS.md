...
> 当前开发版本：`0.1.32`；开发分支：`feature/v0.1.32`；当前生产版本：`0.1.31`（2026-08-31 UTC 已核验）；核对日期：2026-08-31（UTC）；生产域名：`https://paper.pilo.eu.cc`
...
- 集成分支：`dev`。
- 当前开发分支：`feature/v0.1.32`，尚未合并到 `dev -> main`；生产当前运行 `0.1.31`。
- 上一发布分支：`feature/v0.1.31`，已按发布流程合并到 `main`；生产当前仍运行 `0.1.31`。
