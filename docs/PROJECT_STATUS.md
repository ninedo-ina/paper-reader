...
> 当前发布版本：`0.1.31`；发布分支：`feature/v0.1.31`；当前生产版本：`0.1.31`（2026-08-31 UTC 已核验）；核对日期：2026-08-31（UTC）；生产域名：`https://paper.pilo.eu.cc`
...
- 集成分支：`dev`。
- 当前发布分支：`feature/v0.1.31`，已按 `dev -> main` 流程合并；生产当前运行 `0.1.31`。
- 上一发布分支：`feature/v0.1.30`，已按发布流程合并到 `main`；生产已由 `0.1.31` 替换。
