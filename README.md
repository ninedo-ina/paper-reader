...
- Active version branch: `feature/v0.1.14-fix`
- Client version: `0.1.14-fix`
...
- Keep the active version branch (`feature/v0.1.14-fix`), `frontend/package.json`, `frontend/VERSION`, `backend/VERSION`, README release line, favicon cache-busting value, and visible UI version aligned.
