...
- Active version branch: `feature/v0.1.13-fix`
- Client version: `0.1.13-fix`
...
- Keep the active version branch (`feature/v0.1.13-fix`), `frontend/package.json`, `frontend/VERSION`, `backend/VERSION`, README release line, favicon cache-busting value, and visible UI version aligned.
