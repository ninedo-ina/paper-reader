...
- Keep the current release branch (`feature/v0.1.31`), `frontend/package.json`, `frontend/VERSION`, `backend/VERSION`, README release line, favicon cache-busting value, and visible UI version aligned. Production is `0.1.31`; future work starts from the latest `dev`.
