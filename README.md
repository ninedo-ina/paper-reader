...
## Current Iteration: v0.1.50

- Branch: `feature/v0.1.50`
- Requirement: `REQ-202609-0126` — the bookshelf sidebar's four tabs broke as soon as they carried a count badge.
...
- Released version branch: `feature/v0.1.50`
- Client version: `0.1.50`
- Production frontend: `0.1.50` (verified 2026-09-17 UTC)
- Production backend: `0.1.49` — deliberately not restarted for v0.1.50, a frontend-only release with no Kotlin changes (`/api/health` therefore still reports `0.1.49`)
